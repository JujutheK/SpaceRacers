...
planets = [ # mass , distance peri x, distance peri y, velocity x , velocity y, radius and color
    ...
    Physics_SpaceRacers.Physics(5.972168e24, 0.9833 * Physics_SpaceRacers.AU, 0, 0, 30286, 6371000, [0, 0, 225]),  # Earth
...
Players = [Physics_SpaceRacers.Spaceship(1e9, 1000, 0.98358*Physics_SpaceRacers.AU,0,0, 33360.6,1000,[255,255,255], 0,0)]